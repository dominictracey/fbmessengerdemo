var _scq = _scq || [];
_scq.push(['setMerchantId', '144E38A97D807FB9']);
...
var ScarabUtil = function() {
  ...
  devPath:localResource("/dist/build.js"), stagingPath:s3Resource("/discodragstaging/build.js"), durationSeconds:24 * 60 * 60}, instantsearch:{path:s3Resource("/instantsearch/build.js"), devPath:localResource("/dist/build.js"), durationSeconds:24 * 60 * 60}, horus:{path:staticResource("/horus/horus.js"), devPath:localResource("/build/horus.js"), durationSeconds:7 * 24 * 60 * 60}, hooked:{path:staticResource("/hooked/scarab-hooked.js"), devPath:localResource("/hooked/build/scarab-hooked.js")}};
...
;var ScarabModule = function(win, config) {
  ...
  var STRINGS = {VIEWCOOKIE:"scarab.mayViewed", ADDCOOKIE:"scarab.mayAdd", VISITORCOOKIE:"scarab.visitor", PROFILECOOKIE:"scarab.profile", TIMINGSSTORE:"sc_timings", NOCONTAINER:"__no_container__"}, SERIALIZE = {"v":"views", "ai":"addedItems", "ca":"cart", "co":"checkouts", "k":"keywords", "q":"searchTerm", "vc":"category", "cp":"compactProducts", "lang":"language", "currency":"currency", "az":"availabilityZone"}, EVENT = {"pageview":1, "addView":2, "checkAddedItem":3, "addAddedItem":4, "addCartItem":5, 
  "setCart":6, "addCheckoutItem":7, "setPurchase":8, "commit":9}, FEATURETRIGGERS = {"RELATED":{trigger:"view", validate:function(tr) {
  ...
  var loadHelper = function(win, moduleName, explicitConfig, subModule) {
    ...
    var onLoad = [];
    ScarabUtil.loadModule(win, moduleName, ScarabUtil.merge({merchantId:getMerchantId(), onLoad:onLoad}, explicitConfig || {}, sessionConfig || hashConfig), subModule, function() {
      if (ScarabUtil.loadedModules[moduleName].status === "loaded") {
        for (var i = 0;i < onLoad.length;i++) {
          onLoad[i](ScarabUtil.loadedModules[moduleName].instance);
        }
      }
    });
  };
  var publicInterface = {defaultTemplate:'<![CDATA[ {{ if(SC.page.products.length) { }}<div class="scarab-itemlist"><div class="scarab-prev">\u25c0</div>{{ for(var i=0;i<SC.page.products.length;i++) { }}<span data-scarabitem="{{= SC.page.products[i].id }}" class="scarab-item"><a href="{{= SC.page.products[i].link }}"><img src="{{= SC.page.products[i].image }}">{{= SC.page.products[i].title }}</a></span>{{ } }}<div class="scarab-next">\u25b6</div></div>{{ } }} ]]\x3e', testMode:function() {
    ...
    addCookie(STRINGS.VIEWCOOKIE, new Item({i:itemId, t:feature, c:cohort}));
